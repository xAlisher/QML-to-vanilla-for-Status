...
// --- Theme registry ---
const themes = {
  'current-light':  { label: 'Current Light 70 colors',    tokens: 'current', mode: 'light', iteration: 0 },
  'current-dark':   { label: 'Current Dark 67 colors',     tokens: 'current', mode: 'dark',  iteration: 0 },
  'concept-light':  { label: 'Concept A Light 65 colors',  tokens: 'concept', mode: 'light', iteration: 0 },
  'concept-dark':   { label: 'Concept A Dark 69 colors',   tokens: 'concept', mode: 'dark',  iteration: 0 },
  'nord-dark':      { label: 'Nord Dark 52 colors',        tokens: 'nord',    mode: 'dark',  iteration: 0 },
  'dracula-dark':   { label: 'Dracula Dark 55 colors',     tokens: 'dracula', mode: 'dark',  iteration: 0 },
  'monokai-dark':   { label: 'Monokai Dark 53 colors',     tokens: 'monokai', mode: 'dark',  iteration: 0 },
  'logos-light':    { label: 'Logos Light 75 colors',       tokens: 'logos',   mode: 'light', iteration: 0 },
  'solarized-dark': { label: 'Solarized Dark 46 colors',   tokens: 'solarized', mode: 'dark', iteration: 0 },
  'hacker-dark':    { label: 'Hacker Dark 47 colors',      tokens: 'hacker',  mode: 'dark',  iteration: 0 },
  'basecamp-dark':  { label: 'Basecamp Dark 60 colors',    tokens: 'basecamp', mode: 'dark', iteration: 0 },
  'neo-dark':       { label: 'Neo Dark 56 colors',         tokens: 'neo',      mode: 'dark', iteration: 0 },
  'neo-light':      { label: 'Neo Light 57 colors',        tokens: 'neo',      mode: 'light', iteration: 0 },
}
